...
const CONTRACT_NAME = 'Oussnftz';
const CONTRACT_SYMBOL = 'OZ';
...
const GENERIC_DESCRIPTION = "SO WHAT,"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafkreihy3f4yrfuhm7juwfzxfkxewcpe4hcqvjh77bvn3r6ujw4sddsdwa";
